...
//	public ApiResponseBody createUser(@Valid UserCreateRequest userCreateRequest, BindingResult bindingResult) {
//
//		if (bindingResult.hasErrors()) {
//			return new ApiResponseBody(HttpStatus.NOT_ACCEPTABLE.value(), "invalid value");
//		}
//
...
//
//		UserDto userDto = userServiceImpl.readUser(loginId);
//		return new AuthenticationToken(user.getLoginId(), userDto.getAuth(), session.getId());
//	}
